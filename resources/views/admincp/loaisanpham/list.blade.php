        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <table class="table table-bordered" id="postTable">
                    <a type="submit" id="addType" class="btn btn-success" style="margin-top:-8px;"><span id=""
                    ...
                    @foreach($type as $loaisp)
                        <tr class="item{{ $loaisp->id }}">
                            ...
                            <td>
                                <form action="{{ route('loaisanpham.timkiem') }}" method="post"
                                      class="navbar-form navbar-left" role="search">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" ;>
                                    <button type="submit" class="btn btn-success" name="keyword"
                                            value="{{ $loaisp->loaisanpham }}"><span
                                            class="glyphicon glyphicon-eye-open"></span> Xem
                                    </button>
                                </form>
                                ...
                                <button style="margin-top:8px;" data-id="{{ $loaisp->id }}"
                                        data-loaisp="{{ $loaisp->loaisanpham }}"
                                        data-thuonghieu="{{ $loaisp->thuonghieu }}"
                                        data-noidung="{{ $loaisp->noidung }}" id="edit" class="btn btn-primary"><span
                                        class="glyphicon glyphicon-edit"></span> Sửa
                                </button>
                                <button style="margin-top:8px;" data-id="{{ $loaisp->id }}"
                                        data-loaisp="{{ $loaisp->loaisanpham }}" class="btn btn-danger delete"><span
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="noidung_add" name="noidung" cols="40"
                                          rows="5">{{ old('noidung') }}</textarea>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="noidung">Nội dung:</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" id="noidung_edit" name="noidung" cols="40"
                                          rows="5"></textarea>
                                <small>Min: 2, Max: 500, only text</small>
                                <p class="errorNoidung text-center alert alert-danger hidden"></p>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="thuonghieu">Thương hiệu:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="thuonghieu" id="thuonghieu_edit"
                                       value="{{ old('thuonghieu') }}">
                                <p class="errorThuonghieu text-center alert alert-danger hidden"></p>
                            </div>
                        </div>
                    </form>
